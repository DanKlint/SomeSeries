	...
	return (
		<main className={styles["wrapper"]}>
			<form action="" className={styles["form"]} autocomplete="off">
				...
				<div className={styles["inp"]}>
					<InputForm type="password" name="" id="" inputPlaceholder="Пароль" autoComplete="new-password" />
					<i className={styles["fa-solid fa-lock"]}></i>
				</div>
				<div className={styles["inp"]}>
					<InputForm type="password" name="" id="" inputPlaceholder="Подтвердите пароль" autoComplete="new-password" />
					<i className={styles["fa-solid fa-lock"]}></i>
				</div>
				<button className={styles["submit"]}>Зарегистрироваться</button>
				<p className={styles["footer"]}> Есть аккаунт ? <NavLink to="/" className={styles["link"]}>Войти</NavLink></p>
			</form>
